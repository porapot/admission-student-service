...
describe('Admission CRUD routes tests', function () {
    ...
    before(function (done) {
        mockup = {
            fullname_th: 'นายพามณัฏฐ์ ภูติยานันต์',
            student_id: '1101402270230'
            ...
            .end(function (err, res) {
                ...
                request(app)
                    ...
                    .end(function (err, res) {
                        ...
                        assert.equal(resp.data.fullname_th, mockup.fullname_th);
                        assert.equal(resp.data.student_id, mockup.student_id);
                        done();
                    });
            });
            ...
            .end(function (err, res) {
                ...
                request(app)
                    ...
                    .end(function (err, res) {
                        ...
                        var resp = res.body;
                        assert.equal(resp.data.fullname_th, 'name update');
    ...
    xit('should be admission put not use token', function (done) {
    ...
    xit('should be admission delete not use token', function (done) {
